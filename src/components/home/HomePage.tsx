...
const schoolInfo = {
  ...
  recentPosts: [
    ...
    },
    {
      ...
      image: "https://www.fvhospital.com/wp-content/uploads/2021/07/vaccination-french-2.jpg",
    },
    {
      ...
      image: "https://benhviennhitrunguong.gov.vn/wp-content/uploads/2022/03/web-canh-bao-dich-benh-mua-dong-xuan-1.png",
    },
  ],
};
        ...
        >
          ...
          <Box
            sx={{
              ...
              mx: { xs: pageMargins.xs, sm: pageMargins.sm, md: pageMargins.md, lg: pageMargins.lg },
              width: { xs: `calc(100% - ${2 * parseInt(pageMargins.xs)}px)`, 
              ...
              <Box sx={{ 
                ...
                <Box
                  sx={{
                    ...
                    width: "100%",
                    height: "100%",
                    background: "linear-gradient(90deg, #002866 0%, rgba(0,40,102,0.7) 50%, rgba(0,40,102,0) 100%)",
                    zIndex: 3
                  }}
                />
          ...
          {/* Services Section */}
          <Box sx={{ py: 6, px: { xs: pageMargins.xs, sm: pageMargins.sm, md: pageMargins.md, lg: pageMargins.lg } }}>
                ...
                <Box sx={{ width: { xs: "100%", md: "25%" } }}>
                  ...
                  <Box sx={{ mt: 3 }}>
                    ...
                    >
                      ...
                      <Typography variant="body1">Đội ngũ y bác sĩ giỏi chuyên môn</Typography>
                    </Box>
                    ...
                    >
                      ...
                      <Typography variant="body1">Chăm sóc sức khoẻ học sinh toàn diện</Typography>
                    </Box>
                    ...
                    >
                      ...
                      <Typography variant="body1">Trang thiết bị y tế hiện đại</Typography>
                    </Box>
                    ...
                    >
                      ...
                      <Typography variant="body1">Phương pháp khám chữa bệnh tiên tiến</Typography>
                    </Box>
                  </Box>
          ...
          <Box sx={{ 
            py: 5, 
            px: { xs: pageMargins.xs, sm: pageMargins.sm, md: pageMargins.md, lg: pageMargins.lg },
            bgcolor: "white"
          }}>
            {/* Section Title */}
            <Box
                ...
                >
                  ...
                  >
                    <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
                      ...
                      />
                      <Typography variant="body2" sx={{ maxWidth: 300, color: "white", opacity: 0.8 }}>
                        Hệ thống quản lý y tế học đường. Chăm sóc sức khỏe học sinh toàn diện, 
                        giúp phát triển thể chất và tinh thần.
                      </Typography>
                    </Box>
                    ...
                    >
                      <Typography variant="subtitle2" sx={{ color: "white" }}>ĐĂNG KÝ</Typography>
                      ...
                      <Typography variant="caption" sx={{ maxWidth: 200, color: "white", opacity: 0.8 }}>
                        Đăng ký để nhận thông tin mới nhất về các sự kiện y tế và chương trình sức khỏe!
                      </Typography>
                    </Box>
                  </Box>
                </Box>
